            ...
            <ContactSectionText>
              <Text type="heading2" color="grey4">
                ...
                <Text as="span" type="heading2" color="brand1">
                  desenvolver uma solução para sua companhia 
                </Text>
                , juntos!
              </Text>
            </ContactSectionText>
          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou disponível para uma chamada de voz,
                  vamos conversar sobre criatividade juntos?
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Me envie um email reportando feedbacks, sugestãoes e ideias!
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Podemos criar mais interação estando na mesma rede de contatos 
                </Text>
                <Text
                  as="a"
                  color="grey2"
